...
export const formulas: Formula[] = [
  ...
  },
  {
    ...
    category: "okonomi",
    expression: "P/E = aksjekurs / EPS",
    variables: [
      { symbol: "kurs", meaning: "Aksjekurs" },
      { symbol: "EPS", meaning: "Resultat per aksje" },
    ],
    explanation:
      "P/E viser hvor mange år med dagens resultat markedet betaler for. Sammenlign innen bransje.",
    calculatorSlug: "pe-ratio",
  },
  {
    slug: "eps-formel",
    title: "EPS (resultat per aksje)",
    category: "okonomi",
    expression: "EPS = årsresultat / antall aksjer",
    variables: [
      { symbol: "resultat", meaning: "Årsresultat til aksjonærene" },
      { symbol: "aksjer", meaning: "Utestående aksjer" },
    ],
    explanation: "Grunnlag for P/E, PEG og utbetalingsgrad.",
    calculatorSlug: "eps",
  },
  {
    slug: "utbytteavkastning-formel",
    title: "Utbytteavkastning",
    category: "okonomi",
    expression: "yield = DPS / aksjekurs · 100 %",
    variables: [
      { symbol: "DPS", meaning: "Utbytte per aksje" },
      { symbol: "kurs", meaning: "Aksjekurs" },
    ],
    explanation: "Kontantutbytte i prosent av kursen.",
    calculatorSlug: "utbytteavkastning",
  },
  {
    slug: "utbetalingsgrad-formel",
    title: "Utbetalingsgrad",
    category: "okonomi",
    expression: "payout = DPS / EPS · 100 %",
    variables: [
      { symbol: "DPS", meaning: "Utbytte per aksje" },
      { symbol: "EPS", meaning: "Resultat per aksje" },
    ],
    explanation: "Andel av resultatet som betales ut som utbytte.",
    calculatorSlug: "utbetalingsgrad",
  },
  {
    slug: "markedsverdi-formel",
    title: "Markedsverdi",
    category: "okonomi",
    expression: "market cap = aksjekurs · antall aksjer",
    variables: [
      { symbol: "kurs", meaning: "Aksjekurs" },
      { symbol: "n", meaning: "Antall aksjer" },
    ],
    explanation: "Markedspris på egenkapitalen.",
    calculatorSlug: "markedsverdi",
  },
  {
    slug: "pb-formel",
    title: "P/B (price/book)",
    category: "okonomi",
    expression: "P/B = aksjekurs / bokført EK per aksje",
    variables: [
      { symbol: "kurs", meaning: "Aksjekurs" },
      { symbol: "BVPS", meaning: "Bokført egenkapital per aksje" },
    ],
    explanation: "Sammenligner markedspris med bokført egenkapital.",
    calculatorSlug: "pb-ratio",
  },
  {
    slug: "roe-formel",
    title: "ROE",
    category: "okonomi",
    expression: "ROE = resultat / gjennomsnittlig EK · 100 %",
    variables: [
      { symbol: "resultat", meaning: "Årsresultat" },
      { symbol: "EK", meaning: "Gjennomsnittlig egenkapital" },
    ],
    explanation: "Avkastning på eiernes kapital.",
    calculatorSlug: "roe",
  },
  {
    slug: "gearing-formel",
    title: "Gjeldsgrad (D/E)",
    category: "okonomi",
    expression: "D/E = total gjeld / egenkapital",
    variables: [
      { symbol: "D", meaning: "Total gjeld" },
      { symbol: "E", meaning: "Egenkapital" },
    ],
    explanation: "Hvor mye gjeld som står bak hver krone egenkapital.",
    calculatorSlug: "gearing",
  },
  {
    slug: "net-debt-ebitda-formel",
    title: "Net debt / EBITDA",
    category: "okonomi",
    expression: "ratio = (rentebærende gjeld − kontanter) / EBITDA",
    variables: [
      { symbol: "netto gjeld", meaning: "Rentebærende gjeld minus likvider" },
      { symbol: "EBITDA", meaning: "Driftsresultat før avskrivninger" },
    ],
    explanation: "Belåning relativ til driftskontantstrøm-proxy.",
    calculatorSlug: "net-debt-ebitda",
  },
  {
    slug: "enterprise-value-formel",
    title: "Enterprise value",
    category: "okonomi",
    expression: "EV = market cap + rentebærende gjeld − kontanter",
    variables: [
      { symbol: "market cap", meaning: "Markedsverdi av egenkapital" },
      { symbol: "netto gjeld", meaning: "Gjeld minus kontanter" },
    ],
    explanation: "Verdi av hele driftsvirksomheten uavhengig av finansiering.",
    calculatorSlug: "enterprise-value",
  },
  {
    slug: "ev-ebitda-formel",
    title: "EV/EBITDA",
    category: "okonomi",
    expression: "EV/EBITDA = EV / EBITDA",
    variables: [
      { symbol: "EV", meaning: "Enterprise value" },
      { symbol: "EBITDA", meaning: "Driftsresultat før avskrivninger" },
    ],
    explanation: "Vanlig verdsettelsesmultippel på tvers av kapitalstruktur.",
    calculatorSlug: "ev-ebitda",
  },
  {
    slug: "peg-formel",
    title: "PEG-ratio",
    category: "okonomi",
    expression: "PEG = (P/E) / vekst%",
    variables: [
      { symbol: "P/E", meaning: "Price/earnings" },
      { symbol: "vekst%", meaning: "Forventet årlig EPS-vekst i prosent" },
    ],
    explanation: "Setter P/E i forhold til forventet resultatvekst.",
    calculatorSlug: "peg-ratio",
  },
  {
    slug: "totalavkastning-aksje-formel",
    title: "Totalavkastning på aksje",
    category: "okonomi",
    expression: "total = (salg − kjøp + utbytte) / kjøp · 100 %",
    variables: [
      { symbol: "kjøp", meaning: "Kjøpskurs" },
      { symbol: "salg", meaning: "Salgs- eller nåværende kurs" },
      { symbol: "utbytte", meaning: "Utbytte per aksje i perioden" },
    ],
    explanation: "Kursgevinst pluss utbytte relativt til innsats.",
    calculatorSlug: "totalavkastning-aksje",
  },
  {
    slug: "snittkurs-aksje-formel",
    title: "Gjennomsnittlig kjøpspris",
    category: "okonomi",
    expression: "snitt = Σ(antall · kurs) / Σ antall",
    variables: [
      { symbol: "antall", meaning: "Aksjer i hvert kjøp" },
      { symbol: "kurs", meaning: "Kurs i hvert kjøp" },
    ],
    explanation: "Volumvektet cost basis for flere kjøp.",
    calculatorSlug: "snittkurs-aksje",
  },
  {
    slug: "break-even-kurtasje-formel",
    title: "Break-even etter kurtasje",
    category: "okonomi",
    expression: "BE = (kjøpskurs · n + kurtasje_kjøp + kurtasje_salg) / n",
    variables: [
      { symbol: "n", meaning: "Antall aksjer" },
      { symbol: "kurtasje", meaning: "Faste gebyrer ved kjøp og salg" },
    ],
    explanation: "Salgskurs som dekker inn- og utkurtasje.",
    calculatorSlug: "break-even-kurtasje",
  },
  {
    slug: "utbytteinntekt-formel",
    title: "Utbytteinntekt",
    category: "okonomi",
    expression: "utbytte = antall aksjer · DPS",
    variables: [
      { symbol: "n", meaning: "Antall aksjer" },
      { symbol: "DPS", meaning: "Utbytte per aksje" },
    ],
    explanation: "Forventet kontantutbytte før skatt.",
    calculatorSlug: "utbytteinntekt",
  },
  {
    slug: "cagr-aksje-formel",
    title: "CAGR på aksje",
    category: "okonomi",
    expression: "CAGR = (sluttkurs / kjøpskurs)^(1/n) − 1",
    variables: [
      { symbol: "kjøp", meaning: "Kjøpskurs" },
      { symbol: "slutt", meaning: "Salgs- eller nåværende kurs (+ evt. utbytte)" },
      { symbol: "n", meaning: "Antall år" },
    ],
    explanation:
